...
export const About = () => {
	const API_URL_UPCOMING = 'https://api.themoviedb.org/3/movie/upcoming?api_key=d38ddd23464c5200b506ef110d6061b2&language=en-US&page=1';
	const API_URL_TOP_RATED_TV_SHOWS = 'https://api.themoviedb.org/3/tv/top_rated?api_key=d38ddd23464c5200b506ef110d6061b2&language=en-US&page=1';
